  ...
  if (tipo === 'autores') {
    return [
      ...
      },
      {
        ...
        status: "Ativo",
        formacao: "Cursando Psicologia Universidade Federal de São João Del Rei (UFSJ-MG)",
      ...
      },
    {
      ...
      },
      {
        ...
        formacao: "Cursando Ciências da Computação na Universidade Federal de São Paulo (UNIFESP - Campus de São José dos Campos/SP)",
        titulo: "Estudante de Ensino Superior",
        tipoParticipacao: "Colaborador Externo",
        anoIngresso: "2025",
        anoSaida: "Atualmente",
