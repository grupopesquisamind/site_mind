  ...
  if (tipo === 'autores') {
    return [
      ...
      //atenção: se faltar algum campo não irá listar os dados, a ordem aqui não implica, só nome das variáveis
      {
        ...
        formacao: "Administração, Análise e Desenvolvimento de Sistemas, Cursando Pedagogia, Cursando Mestrado em Educação pelo PECIM - Unicamp-SP",
        titulo: "Mestrando",
      ...
      }, 
      {
        ...
        status: "Ativo",
        formacao: "Química, Cursando Pedagogia, Cursando Doutorado em Educação pelo PECIM - Unicamp-SP",
        titulo: "Mestrado",
