  ...
  if (tipo === 'autores') {
    return [
      ...
      }, 
      {
        ...
        status: "Ativo",
        formacao: "Possui Licenciatura Plena em Química pelo Instituto de Química de Araraquara-UNESP e Mestrado em Ciências pela Universidade Federal de Lavras, possui: Especialização em Transtornos Específicos da Aprendizagem e do Neurodesenvolvimento(2025)pela FESP - Faculdade de Educaçao Superior do Paraná; Especialização em Especialização em Educação Especial e Inclusiva (2025) pela Universidade Federal do ABC, UFABC. Cursando Pedagogia, Cursando Doutorado em Educação pelo PECIM - Unicamp-SP, atualmente é lotada no IFSP Campus Jacareí como professora de Química",
        titulo: "Mestrado",
